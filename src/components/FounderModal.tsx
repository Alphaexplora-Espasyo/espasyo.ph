...
const FounderModal = ({ originRect, onClose, src }: FounderModalProps) => {
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center">
      ...
      <div
        ref={modalRef}
        className="relative z-10 flex w-[92vw] max-w-6xl h-[78vh] rounded-2xl overflow-hidden bg-[#2b3327]/90 backdrop-blur-xl shadow-[0_40px_120px_rgba(0,0,0,0.6)] border border-[#DDA79A]/20"
      >
        {/* close */}
        <button
          onClick={handleClose}
          className="absolute top-5 right-5 z-50 text-[#e6dfc8] hover:text-[#DDA79A] transition-colors bg-black/20 p-2 rounded-full backdrop-blur-md"
        >
          <X size={22} />
        </button>
        ...
        <div ref={detailsRef} className="w-[50%] md:w-[42%] h-full px-8 md:px-12 py-12 flex flex-col justify-start relative z-20 -ml-8 overflow-y-auto pointer-events-auto custom-scrollbar">
          ...
          <div className="flex flex-col h-auto min-h-full justify-center">
            <h3 className="uppercase tracking-widest text-[14px] md:text-[18px] text-[#DDA79A] mb-4 font-bold font-display">
              Origin Story
            </h3>
            ...
            <blockquote className="italic text-xl md:text-2xl leading-relaxed opacity-90 mb-8 text-[#efe9d5] font-display border-l-4 border-[#DDA79A] pl-6">
              "Espasyo isn't about the desk you rent. It's about the person sitting next to you."
            </blockquote>

            <div className="mt-auto flex gap-5 pt-4 text-[#DDA79A]">
