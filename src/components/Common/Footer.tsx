...
const Footer = () => {
  ...
  return (
    <footer className="w-full bg-[#FDF4DC] text-[#3A2618] border-t border-[#3A2618]/20 flex flex-col z-50 relative pb-8">
      <div className="flex-1 px-4 sm:px-8 md:px-16 py-8 sm:py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 sm:gap-8 md:gap-12">
          ...
          <div className="md:col-span-3">
            ...
            <div className="font-body text-xs sm:text-sm text-[#3A2618]/80 space-y-2 sm:space-y-4">
          ...
          <div className="md:col-span-3">
            <h4 className="font-display text-xs font-bold uppercase tracking-widest mb-3 sm:mb-4 md:mb-6 text-[#3A2618]/60">Stay Connected</h4>
        ...
        <div className="flex flex-col items-center gap-6 sm:gap-7 md:gap-8">
          <div className="flex flex-col items-center gap-4 sm:gap-5 md:gap-6">
            <h4 className="font-display text-xs font-bold uppercase tracking-wider text-[#3A2618]/60">Accredited By</h4>
          ...
          <div className="flex flex-col items-center text-center px-4">
            <p className="font-body text-xs md:text-sm text-[#3A2618]/40">
              © {currentYear} Espasyo Coworking Space. All rights reserved.
            </p>
            <p className="font-body text-[10px] md:text-xs text-[#3A2618]/40 mt-1.5 tracking-wide">
              Powered by{' '}
              <a
